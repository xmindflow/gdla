...
from modules.decoder.mhla import MHLA
from registry import MODEL
from timm.layers import trunc_normal_


class PVTLA(nn.Module):
    def __init__(
            self,
            in_chs: int,
            n_classes: int,
...
def build_model(cfg) -> nn.Module:
    return PVTLA(
        ...
        use_rope=cfg.MODEL.LA.USE_ROPE,
        rope_base=cfg.MODEL.LA.ROPE_BASE,
        img_size=cfg.MODEL.LA.IMG_SIZE,
