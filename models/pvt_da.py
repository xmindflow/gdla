...
from modules.decoder.mhda import MHDA
from registry import MODEL
from timm.layers import trunc_normal_


class PVTDA(nn.Module):
    def __init__(
            self,
            in_chs: int,
            n_classes: int,
...
def build_model(cfg) -> nn.Module:
    return PVTDA(
        ...
        use_rope=cfg.MODEL.DIFF_ATTN.USE_ROPE,
        rope_base=cfg.MODEL.DIFF_ATTN.ROPE_BASE,
        img_size=cfg.MODEL.DIFF_ATTN.IMG_SIZE,
