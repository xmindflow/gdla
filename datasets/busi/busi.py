...
def build_dataset(cfg) -> Dict[str, Callable[[], Dataset]]:
    ...
    return {
        'train': partial(BUSI, data_dir=cfg.DATA.TRAIN_DIR, transform=train_transform),
        'val': partial(BUSI, data_dir=cfg.DATA.VAL_DIR, transform=val_transform),
        'test': partial(BUSI, data_dir=cfg.DATA.TEST_DIR, transform=test_transform)
    }
